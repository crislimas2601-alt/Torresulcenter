        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500">
              Controle individual por contrato, parcelas de comissão e status de recebimento
            </p>
          </div>

          {/* Quick status tabs */}
          <div className="inline-flex items-center bg-slate-100 p-0.5 rounded-md text-xs font-medium text-slate-600 border border-slate-200/80 self-start sm:self-auto">
            <button
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 pt-1">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-slate-50 hover:bg-slate-100/60 focus:bg-white border border-slate-200 rounded-md text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-red-600 focus:border-red-600 transition-colors"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="px-3 py-2 bg-slate-50 border border-slate-200 rounded-md text-xs text-slate-700 focus:outline-none focus:ring-1 focus:ring-red-600 cursor-pointer"
            >
        ...
        {filteredDeals.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-xs font-medium rounded-md transition-colors cursor-pointer"
            >
            ...
            return (
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 bg-slate-50/80 p-3 rounded-lg border border-slate-200 shrink-0">
                    <div>
                      <span className="text-[11px] font-medium text-slate-500 block">VGV da venda</span>
                      <span className="text-sm font-bold text-slate-900 font-heading tabular-nums">
                    ...
                    <div className="col-span-2 sm:col-span-1">
                      ...
                      <div className="flex items-baseline gap-1 mt-0.5">
                        <span className="text-sm font-bold text-emerald-700 font-heading tabular-nums">
                  ...
                  <div className="flex items-center justify-end gap-2 shrink-0">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-slate-200 text-xs font-medium text-slate-700 hover:bg-slate-100 transition-colors cursor-pointer"
                    >
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-100 bg-slate-50/50 -mx-4 -mb-4 sm:-mx-5 sm:-mb-5 p-4 sm:p-5">
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        Cronograma de parcelas da venda
                      </h4>
                        ...
                        return (
                          ...
                          >
                            ...
                            <button
                              ...
                              className={`px-2.5 py-1.5 rounded-md font-medium text-xs transition-colors flex items-center gap-1 cursor-pointer shrink-0 ${
                                isPaid
                    ...
                    {deal.notes && (
                      <div className="mt-3 p-2.5 rounded-md bg-amber-50/50 border border-amber-100 text-xs text-amber-900">
